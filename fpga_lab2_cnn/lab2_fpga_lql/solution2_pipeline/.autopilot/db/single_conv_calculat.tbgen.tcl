...
set C_modelArgList {
	{ cal_conv int 32 regular {array 9 { 1 1 } 1 1 } {global 0}  }
	{ kernel int 32 regular {array 9 { 1 1 } 1 1 } {global 0}  }
}
...
set portList { 
	...
	{ cal_conv_address1 sc_out sc_lv 4 signal 0 } 
	{ cal_conv_ce1 sc_out sc_logic 1 signal 0 } 
	{ cal_conv_q1 sc_in sc_lv 32 signal 0 } 
...
set Spec2ImplPortList { 
	cal_conv { ap_memory {  { cal_conv_address0 mem_address 1 4 }  { cal_conv_ce0 mem_ce 1 1 }  { cal_conv_q0 mem_dout 0 32 }  { cal_conv_address1 MemPortADDR2 1 4 }  { cal_conv_ce1 MemPortCE2 1 1 }  { cal_conv_q1 MemPortDOUT2 0 32 } } }
