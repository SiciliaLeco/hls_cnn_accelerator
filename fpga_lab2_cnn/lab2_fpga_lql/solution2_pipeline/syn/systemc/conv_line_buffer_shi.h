...
struct conv_line_buffer_shi : public sc_module {
    ...
    sc_signal< sc_lv<32> > cal_conv_load_reg_141;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<32> > cal_conv_load_1_reg_146;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_reg_151;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_1_reg_157;
    sc_signal< sc_lv<32> > cal_conv_load_11_reg_163;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<32> > cal_conv_load_12_reg_168;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_4_reg_173;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_5_reg_178;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_6_reg_183;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_7_reg_188;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_8_reg_193;
    sc_signal< sc_logic > ap_CS_fsm_state6;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_9_reg_198;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_10_reg_203;
    sc_signal< sc_logic > ap_CS_fsm_state7;
    sc_signal< sc_lv<32> > conv_line_buffer_loa_11_reg_208;
