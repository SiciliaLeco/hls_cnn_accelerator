...
void single_conv_test::thread_hdltv_gen() {
    ...
    while (1) {
        ...
        mHdltvoutHandle << " , " <<  " \"imgtotal_address1\" :  \"" << imgtotal_address1.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"imgtotal_ce1\" :  \"" << imgtotal_ce1.read() << "\" ";
        mHdltvinHandle << " , " <<  " \"imgtotal_q1\" :  \"" << imgtotal_q1.read() << "\" ";
        ...
        mHdltvoutHandle << " , " <<  " \"weitotal_address1\" :  \"" << weitotal_address1.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"weitotal_ce1\" :  \"" << weitotal_ce1.read() << "\" ";
        mHdltvinHandle << " , " <<  " \"weitotal_q1\" :  \"" << weitotal_q1.read() << "\" ";
