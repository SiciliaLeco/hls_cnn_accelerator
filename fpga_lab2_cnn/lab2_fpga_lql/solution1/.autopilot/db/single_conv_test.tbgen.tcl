...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "70162", "EstimateLatencyMax" : "217618",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state19", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_conv_line_buffer_shi_fu_620"},
			{"State" : "ap_ST_fsm_state22", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_conv_line_buffer_shi_fu_620"},
			{"State" : "ap_ST_fsm_state20", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_single_conv_calculat_fu_630"},
			{"State" : "ap_ST_fsm_state17", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_single_conv_calculat_fu_630"}],
		"Port" : [
			...
			{"Name" : "kernel", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_single_conv_calculat_fu_630", "Port" : "kernel"}]},
			{"Name" : "cal_conv", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_single_conv_calculat_fu_630", "Port" : "cal_conv"},
					{"ID" : "7", "SubInstance" : "grp_conv_line_buffer_shi_fu_620", "Port" : "cal_conv"}]},
			{"Name" : "conv_line_buffer", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "grp_conv_line_buffer_shi_fu_620", "Port" : "conv_line_buffer"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cal_conv_U", "Parent" : "0"},
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_conv_line_buffer_shi_fu_620", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "conv_line_buffer", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "cal_conv", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_single_conv_calculat_fu_630", "Parent" : "0",
...
set ArgLastReadFirstWriteLatency {
	single_conv_test {
		imgtotal {Type I LastRead 3 FirstWrite -1}
		weitotal {Type I LastRead 4 FirstWrite -1}
		outtotal {Type O LastRead -1 FirstWrite 16}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "70162", "Max" : "217618"}
	, {"Name" : "Interval", "Min" : "70163", "Max" : "217619"}
]}
